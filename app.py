...
def fetch_poster(movie_id):
    url = f"https://api.themoviedb.org/3/movie/{movie_id}?api_key=4bf956aa4c71bb0817e16e4ff9b6e0c5"
    ...
    try:
        ...
        if poster_path:
            ...
            return "https://via.placeholder.com/500x750?text=No+Image"  # Placeholder if no poster
